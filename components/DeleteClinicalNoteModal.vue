  ...
  >
    <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
      ...
      <div class="pb-3 border-b">
        <h3 class="text-xl font-semibold text-gray-900">Delete Clinical Note</h3>
      </div>
...
const handleDelete = async () => {
  ...
  try {
    await $fetch(`/api/clinical-notes/${props.clinicalNoteId}/delete`, {
      method: 'POST',
    });
    ...
    errorMessage.value = error.data?.message || 'Failed to delete clinical note. Please try again.';
  } finally {
